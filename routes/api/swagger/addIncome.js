const incomeSwagger = {
              ...
              schema: {
                ...
                properties: {
                  ...
                  category: {
                    type: 'string',
                    example: 'Salary',
                    description: 'The category of the income. Valid categories include Salary and Other income.',
                  },
                  description: {
                    type: 'string',
                  ...
                  date: {
                    ...
                    format: 'date',
                    example: '2024-10-01',
                    description: 'The date of the income. If not provided, the current date will be used.',
                  },
                },
              },
            },
  ...
  module.exports = addIncomeSwagger;