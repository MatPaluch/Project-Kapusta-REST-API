const userData = {
    "/user": {
      get: {
        ...
        description: "Retrieves the logged-in user's profile data, including avatar URL, email, balance, and a list of their transactions.",
        security: [{ bearerAuth: [] }],
        tags: ["User"],
        responses: {
          200: {
                ...
                schema: {
                  ...
                  properties: {
                    avatarURL: {
                      ...
                      example: "https://s.gravatar.com/avatar/b871b144b4a00401dcc0bb73bf6cb509?s=300&d=wavatar"
                    },
                    email: {
                      type: "string",
                    ...
                    transactions: {
                      type: "array",
                      description: "List of the user's transactions, sorted by date.",
                      items: {
                        type: "object",
                        properties: {
                          _id: {
